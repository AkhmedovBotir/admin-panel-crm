...
function CreateApplication() {
  ...
  useEffect(() => {
    if (quillRef.current && !editorRef.current) {
      editorRef.current = new Quill(quillRef.current, {
        theme: 'snow',
        placeholder: "So'rov tafsilotlarini kiriting...",
        modules: {
          toolbar: [
            [{ 'header': [1, 2, 3, false] }],
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Yangi so'rov:", newApp);
      
      toast.success("So'rov muvaffaqiyatli yaratildi");
      navigate("/applications");
    } catch (error) {
      console.error("So'rovni yaratishda xatolik:", error);
      toast.error("So'rovni yaratishda xatolik yuz berdi");
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800">Yangi so'rov yaratish</h1>
          </div>
            ...
            <div className="grid grid-cols-1 gap-8">
              <div>
                ...
                <input
                  ...
                  required
                  placeholder="So'rov sarlavhasini kiriting"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    required
                    placeholder="So'rov kodini kiriting"
                  />
                </div>
