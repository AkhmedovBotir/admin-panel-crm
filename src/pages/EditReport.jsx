...
const staticReports = [
  {
    ...
    departmentId: 1,
    employeeId: 1,
    description: "<p>Test hisobot</p>",
    createdDate: "2024-01-26T10:00:00",
    updatedDate: "2024-01-26T10:00:00",
    visible: true
  }
];
...
function EditReport() {
  ...
  useEffect(() => {
    ...
    const existingReport = staticReports.find(r => r.id === parseInt(id));
    if (!existingReport) {
  ...
  useEffect(() => {
    if (quillRef.current && !editorRef.current) {
      ...
      editorRef.current.root.innerHTML = report.description;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Yangilangan hisobot:", updatedReport);
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800">Hisobotni tahrirlash</h1>
          </div>
